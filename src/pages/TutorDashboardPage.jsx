...
const activity = [
  ...
  {
    id: "a2",
    label: "Review posted by Kavisha Fernando (★ 5)",
    time: "2h ago",
  },
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                Unlock profile boost, priority badge, analytics, and booking
                automation.
              </p>
            </div>
            <Link
              ...
              <AnimatePresence>
                {!profile && !profileLoading ? (
                  ...
                  >
                    ...
                    <code>supabase/schema.sql</code> so the trigger can populate
                    it.
                  </motion.p>
                ) : null}
              </AnimatePresence>
