...
export default function StudentLiveJoinPage() {
  ...
  return (
    <section className="min-h-screen bg-[#f5f5f7] px-6 py-8 dark:bg-slate-950">
      <div className="mx-auto max-w-6xl space-y-4">
        ...
        {loading ? (
          <div className="rounded-2xl bg-white p-4 text-sm font-semibold text-slate-600 ring-1 ring-slate-200/70 dark:bg-slate-900 dark:text-slate-300 dark:ring-white/10">
            Loading meeting...
          </div>
        ) : !meeting ? (
          ...
          <div className="space-y-3">
            <div className="rounded-2xl bg-white p-4 ring-1 ring-slate-200/70 dark:bg-slate-900 dark:ring-white/10">
              ...
              <input
                ...
                className="mt-2 h-10 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 dark:border-white/10 dark:bg-slate-950 dark:text-white"
              />
            </div>
            <LiveRoom
