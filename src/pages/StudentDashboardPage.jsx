...
/** Mock data — replace with Supabase when bookings & saves exist */
        ...
        <aside className="space-y-6">
            ...
            <AnimatePresence>
              {!profile && !profileLoading ? (
                ...
                >
                  ...
                  and you signed up as a student.
                </motion.p>
              ) : null}
            </AnimatePresence>
          </motion.section>
          ...
          >
            ...
            <p className="text-xs leading-relaxed text-slate-600 dark:text-slate-300">
              ...
              location. Favourite tutors you like so you can message them quickly
              from here once live data is connected.
            </p>
