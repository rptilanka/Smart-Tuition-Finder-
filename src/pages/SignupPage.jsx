...
export default function SignupPage() {
  ...
  return (
    ...
    >
      ...
      >
        <TabsList className="grid h-11 w-full grid-cols-2 rounded-full bg-slate-200/90 p-1 dark:bg-slate-800/90">
          <TabsTrigger
            value="student"
            className="rounded-full text-sm font-semibold text-slate-600 data-[state=active]:bg-white data-[state=active]:text-slate-950 data-[state=active]:shadow-sm dark:text-slate-300 dark:data-[state=active]:bg-slate-950 dark:data-[state=active]:text-white"
          >
            Student
          </TabsTrigger>
          <TabsTrigger
