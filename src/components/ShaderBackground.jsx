...
const fsSource = `
  ...
  void main() {
    ...
    // Beam intensity as a 0-1 mask, faded at edges
    float beamMask = clamp(length(lines.rgb) * 0.65, 0.0, 1.0) * verticalFade;
    vec4 beamColor = vec4(0.5, 0.1, 0.9, 1.0);
    vec4 fragColor = mix(bgColor, beamColor, beamMask);
    fragColor.a = 1.0;
