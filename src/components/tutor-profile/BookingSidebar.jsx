        ...
        <div className="relative z-10 mt-5 space-y-2">
          {isOwnProfile ? (
            <>
              <Link
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-full glass-btn bg-neutral-950 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-neutral-800 dark:bg-neutral-800 dark:text-white dark:hover:bg-neutral-700"
              >
                <Settings size={16} />
                Edit profile
              </Link>
              <Link
                to="/tutor-dashboard"
                className="inline-flex w-full items-center justify-center gap-2 rounded-full glass-btn bg-slate-100 px-4 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-200/90 active:scale-[0.99] dark:bg-neutral-800 dark:text-slate-50 dark:hover:bg-slate-700"
              >
          ...
          <div className="flex items-center gap-2">
            <motion.button
              ...
              onClick={share}
              whileTap={{ scale: 0.97 }}
              className="inline-flex flex-1 items-center justify-center gap-2 rounded-full glass-btn bg-primary/12 px-4 py-2.5 text-sm font-semibold text-primary shadow-none transition hover:bg-primary/20 active:scale-[0.99] dark:bg-primary/20 dark:text-teal-50 dark:hover:bg-primary/30"
            >
          ...
          <div className="relative z-10 mt-5 border-t border-slate-200 pt-4 dark:border-white/10">
            ...
            <ul className="mt-2 space-y-1.5">
              {nextSlots.map((slot) => (
                ...
                >
                  <span>{slot.day}</span>
                  <span className="rounded-full glass-btn bg-slate-100 px-2 py-0.5 text-slate-600 dark:bg-neutral-800 dark:text-slate-300">
                    {slot.time}
                  </span>
                </li>
              ))}
