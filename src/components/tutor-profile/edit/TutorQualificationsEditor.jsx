...
/**
 * Long-form qualifications, certifications, and experience for Supabase
 * `tutor_accounts.qualifications_experience`.
 */
export default function TutorQualificationsEditor({
  value,
  onChange,
  disabled,
  maxLength = 4000
      ...
      <header className="mb-4 flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Degrees, certifications, years of experience, and what makes your teaching credible.
          </p>
        </div>
      </header>
      <label className="block">
        <span className="sr-only">Qualifications and experience</span>
        <textarea
          value={value}
          ...
          rows={8}
          maxLength={maxLength}
          placeholder="Example: BSc (Hons) Mathematics, University of Colombo · Cambridge CELTA · 10+ years O/L and A/L classroom and private tutoring…"
